...
!MH!#endif
  ...
  subroutine initialise_glint(params,                     &
    ...
    logical,                  optional,intent(in)  :: ccsm_rst    !    logical flag to hotstart from a CCSM restart file
    ...
    logical :: restart   ! true if ccsm_rst is present and hotstarting from a CCSM restart file
