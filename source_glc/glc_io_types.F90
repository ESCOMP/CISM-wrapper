...
!-----------------------------------------------------------------------
   ...
   if (.not. att_exists) then
      ...
      call exit_glc(sigAbort,'Unknown file attribute')
   endif
...
!-----------------------------------------------------------------------
   ...
   if (.not. att_exists) then
      ...
      call exit_glc(sigAbort,'Unknown iofield attribute')
   endif
...
!-----------------------------------------------------------------------
   ...
   if (nml_error /= 0) then
      call exit_glc(sigAbort,'ERROR reading io_nml')
   endif
