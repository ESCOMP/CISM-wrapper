...
project = u'cismdoc'
copyright = u'2017, William Lipsco'
author = u'William Lipsco'
...
latex_documents = [
    (master_doc, 'cismdoc.tex', u'cismdoc Documentation',
     u'William Lipsco', 'manual'),
]
