...
!lipscomb - added basal diffusivity 
    real(dp),dimension(:,:)  ,pointer :: diffu_bas => null()   !*FD basal diffusivity
...
!lipscomb - added diffu_bas
    call coordsystem_allocate(model%general%velo_grid, model%velocity%diffu_bas)
...
!lipscomb - added diffu_bas
    deallocate(model%velocity%diffu_bas)
